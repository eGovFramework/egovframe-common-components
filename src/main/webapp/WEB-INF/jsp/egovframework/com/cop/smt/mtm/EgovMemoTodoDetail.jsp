...
<form:form modelAttribute="memoTodoVO" name="memoTodoVO" method="post" action="${pageContext.request.contextPath}/cop/smt/mtm/modifyMemoTodo.do' />">
...
<div class="wTableFrm">
	...
	<div class="btn">		
		...
		<span class="btn_s"><a href="javascript:void(0);" onclick="fn_egov_delete_memotodo(); return false;"><spring:message code="button.delete" /></a></span>
      <% 
