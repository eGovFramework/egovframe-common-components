...
<!-- 상단타이틀 -->
<form:form modelAttribute="commuMasterVO" action="${pageContext.request.contextPath}/cop/cmy/updateCommuMaster.do" method="post" onSubmit="fn_egov_updt_commu(document.forms[0]); return false;">  
<div class="wTableFrm">
