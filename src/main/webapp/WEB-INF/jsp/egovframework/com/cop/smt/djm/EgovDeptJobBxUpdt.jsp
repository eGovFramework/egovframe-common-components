...
<form:form modelAttribute="deptJobBxVO" name="deptJobBxVO" method="post" action="${pageContext.request.contextPath}/cop/smt/djm/updateDeptJobBx.do' />">
	...
	<div class="wTableFrm">
		...
		<div class="btn">
			...
			<span class="btn_s"><a href="<c:url value='/cop/smt/djm/deleteDeptJobBx.do'/>?deptJobBxId=<c:out value='${deptJobBxVO.deptJobBxId}'/>" onclick="fn_egov_delete_deptjobbx(); return false;"><spring:message code="button.delete" /></a></span>
