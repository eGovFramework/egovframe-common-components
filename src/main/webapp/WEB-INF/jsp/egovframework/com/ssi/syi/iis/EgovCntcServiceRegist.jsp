...
function fn_egov_list_CntcService(){
	var varForm = document.cntcService;
	varForm.cmd.value = "";
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <select class="select" disabled="disabled" title="<spring:message code="comSsiSyiIis.cntcServiceRegist.insttId"/>"><!-- 기관선택 (name 제거 - hidden field로 값 전송) -->
		...
		<tr>
			...
			<td class="left">
			    <select class="select" disabled="disabled" title="<spring:message code="comSsiSyiIis.cntcServiceRegist.sysId"/>"><!-- 시스템선택 (name 제거 - hidden field로 값 전송) -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="#" onclick="fn_egov_list_CntcService(); return false;"><spring:message code="button.list"/></a></span><!-- 목록 -->
	</div>
