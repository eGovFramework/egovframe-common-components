...
<html lang="ko">
	<head>
		...
		function fnModify(){
			...
			varForm.action           = "<c:url value='/dam/map/tea/EgovComDamMapTeamModifyView.do'/>";
	...
	<form name="Form" action="${pageContext.request.contextPath}/dam/map/tea/EgovComDamMapTeamModifyView.do" method="post">
