...
<form:form modelAttribute="batchSchdul" id="batchSchdul" action="${pageContext.request.contextPath}/sym/bat/updateBatchSchdul.do" method="post">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="comSymBat.batchSchdulUpdt.batchOpertNm"/></th><!-- 배치작업명 -->
			<td class="left">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
