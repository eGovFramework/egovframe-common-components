...
<form:form name="PrivacyLogForm" modelAttribute="searchVO" action="${pageContext.request.contextPath}/sym/log/plg/SelectPrivacyLogList.do" method="post" onSubmit="fn_egov_search_privacyLog(); return false;"> 
<div class="board">
