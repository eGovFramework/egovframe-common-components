...
<!-- 상단타이틀 -->
<form:form modelAttribute="batchSchdul"  action="${pageContext.request.contextPath}/sym/bat/addBatchSchdul.do" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
