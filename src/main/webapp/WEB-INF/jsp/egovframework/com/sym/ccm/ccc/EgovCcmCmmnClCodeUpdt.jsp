...
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			    <form:input path="clCode" title="${title} ${inputTxt}" size="70" maxlength="3" readonly="true" />
	...
	<div class="btn">
		...
		<span class="btn_s">
		<a href="<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeList.do' />" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
		</span>
