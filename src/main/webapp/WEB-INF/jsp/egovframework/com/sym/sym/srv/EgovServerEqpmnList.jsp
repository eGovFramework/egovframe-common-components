...
<div class="board">
	...
	<form:form name="listForm" modelAttribute="searchVO" action="${pageContext.request.contextPath}/sym/sym/srv/selectServerEqpmnList.do" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="javascript:void(0);" onclick="fncAddServerEqpmnInsert(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="serverEqpmn" items="${serverEqpmnList}" varStatus="status">
			  <tr>
			    <td>
			        <a href="javascript:void(0);" onclick="fncSelectServerEqpmn('<c:out value="${serverEqpmn.serverEqpmnId}"/>'); return false;"><span class="link"><c:out value="${serverEqpmn.serverEqpmnId}"/></span></a>
			    </td>
