...
<form name="CcmCodeForm" action="${pageContext.request.contextPath}/sym/ccm/cca/UpdateCcmCmmnCodeView.do" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onClick="fn_egov_delete_code('<c:out value="${result.codeId}"/>'); return false;" title="<spring:message code="title.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
