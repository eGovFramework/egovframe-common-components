...
<form:form name="WebLogForm" modelAttribute="searchVO" action="${pageContext.request.contextPath}/sym/log/wlg/SelectWebLogList.do" method="post" onSubmit="fn_egov_search_webLog(); return false;"> 
<div class="board">
