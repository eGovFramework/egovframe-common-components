...
<form:form modelAttribute="backupOpert"  action="${pageContext.request.contextPath}/sym/sym/bak/addBackupOpert.do" method="post">
...
<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" /></noscript><!-- 자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다. -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
