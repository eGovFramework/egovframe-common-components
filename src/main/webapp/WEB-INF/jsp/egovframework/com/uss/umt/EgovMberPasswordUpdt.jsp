...
<body>
        <!-- content start -->
        <form:form modelAttribute="mberPasswordManageVO" method="post"  action="${pageContext.request.contextPath}/uss/umt/EgovMberPasswordUpdt.do" onsubmit="fnUpdate(document.forms[0]); return false;">
