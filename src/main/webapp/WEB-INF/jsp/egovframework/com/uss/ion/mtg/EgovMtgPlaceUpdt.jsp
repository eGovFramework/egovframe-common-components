...
<form:form modelAttribute="mtgPlaceManageVO" name="mtgPlaceManageVO" id="mtgPlaceManageVO" method="post" action="${pageContext.request.contextPath}/uss/ion/mtg/updtMtgPlace.do"  enctype="multipart/form-data"> 
...
<!--  첨부파일 테이블 레이아웃 End. /cmm/fms/selectImageFileInfs.do -->
	<c:if test="${mtgPlaceManageVO.atchFileId eq null || mtgPlaceManageVO.atchFileId eq ''}">
		...
		<tr>
			...
			<td class="left">
				<select name="aceptncPosblNmpr" title="수용가능인원">
			       	<option value="5"   <c:if test="${mtgPlaceManageVO.aceptncPosblNmpr == '5'}" > selected </c:if>>5<spring:message code="comUssIonMtg.mtgPlaceManageList.persons" /></option>
