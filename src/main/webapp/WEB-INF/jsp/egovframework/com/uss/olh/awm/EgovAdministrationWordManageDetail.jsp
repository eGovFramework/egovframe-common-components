...
<form name="administrationWordForm" action="${pageContext.request.contextPath}/uss/olh/awm/updateAdministrationWordView.do" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onClick="fn_egov_delete_administrationword('<c:out value="${result.administWordId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
