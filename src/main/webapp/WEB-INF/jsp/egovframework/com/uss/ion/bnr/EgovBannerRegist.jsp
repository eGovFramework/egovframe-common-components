...
<form:form id="bannerVO" modelAttribute="bannerVO" method="post" action="${pageContext.request.contextPath}/uss/ion/bnr/addBanner.do" enctype="multipart/form-data"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				<input id="bannerNm" type="text" name="bannerNm" value="<c:out value='${bannerVO.bannerNm}'/>" title="<spring:message code="ussIonBnr.bannerRegist.bannerNm"/>" maxLength="10" style="width:188px" />
		...
		<tr>
			...
			<td class="left">
				<input id="linkUrl" type="text" name="linkUrl" value="<c:out value='${bannerVO.linkUrl}'/>" title="<spring:message code="ussIonBnr.bannerRegist.linkUrl"/>" maxLength="255" />
		...
		<tr>
			...
			<td class="left">
				...
				</div><input name="bannerImage" id="bannerImage" type="text" title="<spring:message code="ussIonBnr.bannerRegist.bannerImage"/>" value="<c:out value="${bannerVO.bannerImage}"/>" maxLength="30" readonly="readonly" style="width:525px" />
		...
		<tr>
			...
			<td class="left">
				<input id="bannerDc" type="text" name="bannerDc" value="<c:out value='${bannerVO.bannerDc}'/>" title="<spring:message code="ussIonBnr.bannerRegist.bannerDc"/>" maxLength="100" />
			</td>
		</tr>
		<tr>
			<th><spring:message code="ussIonBnr.bannerRegist.sortOrdr"/> <span class="pilsu">*</span></th><!-- 정렬순서 -->
			<td class="left">
				<input id="sortOrdr" type="text" name="sortOrdr" title="<spring:message code="ussIonBnr.bannerRegist.sortOrdr"/>" value="<c:out value='${bannerVO.sortOrdr}'/>" maxLength="5" style="width:68px" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onclick="fncSelectBannerList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
