...
<!-- 상단타이틀 -->
<form:form modelAttribute="indvdlPgeVO" action="${pageContext.request.contextPath}/uss/mpe/updateIndvdlPge.do" method="post" onSubmit="fn_egov_updt_pge(document.forms[0]); return false;">  
<div class="wTableFrm">
