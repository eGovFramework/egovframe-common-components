...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/uss/umt/EgovEmplyrDelete.do'/>";
...
function fnAddUserView() {
    document.listForm.action = "<c:url value='/uss/umt/EgovEmplyrInsertView.do'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/uss/umt/EgovEmplyrManage.do'/>";
    document.listForm.submit();
}
function fnSearch(){
...
<form:form name="listForm" modelAttribute="searchVO" action="${pageContext.request.contextPath}/uss/umt/EgovEmplyrManage.do" method="post"> 
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="javascript:void(0);" onClick="fnAddUserView(); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
