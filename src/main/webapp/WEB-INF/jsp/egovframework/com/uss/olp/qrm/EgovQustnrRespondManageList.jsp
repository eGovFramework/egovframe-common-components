<%--
  ...
  Modification Information
    ...
    2024.10.29   권태성			pageIndex 파라미터 주석 제거, 등록 페이지 신규 경로로 변경
...
function fn_egov_detail_QustnrRespondManage(qestnrRespondId){
	document.listForm.qestnrRespondId.value = qestnrRespondId;
	document.listForm.action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageDetail.do'/>";
	document.listForm.submit();
}
