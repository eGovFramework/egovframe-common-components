...
<form name="eventCmpgnForm" action="${pageContext.request.contextPath}/uss/ion/ecc/updateEventCmpgnView.do" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onClick="fn_egov_delete_event('<c:out value="${result.eventId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
