...
<form:form name="hpcmForm" modelAttribute="searchVO" action="${pageContext.request.contextPath}/uss/olh/hpc/selectHpcmList.do" method="post" onSubmit="fn_egov_search_hpcm(); return false;"> 
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="#" onclick="fn_egov_postNavigate('<c:url value='/uss/olh/hpc/insertHpcmView.do' />'); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="javascript:void(0);" onClick="fn_egov_inquire_hpcmdetail('<c:out value="${resultInfo.hpcmId}"/>');return false;"><c:out value='${fn:substring(resultInfo.hpcmDf, 0, 40)}'/></a></td>
