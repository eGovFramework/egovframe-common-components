...
<form name="hpcmForm" action="${pageContext.request.contextPath}/uss/olh/hpc/updateHpcmView.do" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="javascript:void(0);" onClick="fn_egov_delete_hpcm('<c:out value="${result.hpcmId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
