...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="#" onclick="fn_egov_postNavigate('<c:url value='/uss/olp/cns/CnsltListInqire.do' />'); return false;"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
