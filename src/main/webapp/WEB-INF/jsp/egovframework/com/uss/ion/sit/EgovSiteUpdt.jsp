...
<!-- 상단타이틀 -->
<form:form modelAttribute="siteVO" action="${pageContext.request.contextPath}/uss/ion/sit/updateSite.do" method="post" onSubmit="fn_egov_updt_site(document.forms[0]); return false;">  
<div class="wTableFrm">
