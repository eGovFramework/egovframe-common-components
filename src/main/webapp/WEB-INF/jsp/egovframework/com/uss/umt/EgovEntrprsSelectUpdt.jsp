<%
 /**
  * @Class Name : EgovEntrprsSelectUpdt.jsp
...
function fnDeleteEntrprs(checkedIds) {
	if(confirm("<spring:message code="common.delete.msg" />")){
	    ...
	    document.entrprsManageVO.action = "<c:url value='/uss/umt/EgovEntrprsDelete.do'/>";
	    document.entrprsManageVO.submit();
	}
}
...
function fnLockIncorrect(){
	if(confirm("<spring:message code="comUssUmt.common.lockAtConfirm" />")){
	    document.entrprsManageVO.action = "<c:url value='/uss/umt/EgovEntrprsLockIncorrect.do'/>";
	    document.entrprsManageVO.submit();
	}
}
...
<body>
<!-- content start -->
<form:form modelAttribute="entrprsManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovEntrprsSelectUpdt.do" name="entrprsManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;"> 
<!-- <div class="wTableFrm"> -->
...
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			<th>${title} <span class="pilsu">*</span></th>
			<td class="left">
                    <form:input path="zip" id="zip" title="${title} ${inputTxt}" size="20" maxlength="8" cssStyle="width:60px;" />
...
<!-- 2021.05.30, 정진오, 디지털원패스 연동해지 -->
<form:form id="onepassForm" name="onepassForm" modelAttribute="entrprsManageVO" method="post">
