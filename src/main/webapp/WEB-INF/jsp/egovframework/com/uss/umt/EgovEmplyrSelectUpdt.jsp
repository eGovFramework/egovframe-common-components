...
function fnDeleteUser(checkedIds) {
	if(confirm("<spring:message code="common.delete.msg" />")){
	    document.emplyrManageVO.checkedIdForDel.value=checkedIds;
	    document.emplyrManageVO.action = "<c:url value='/uss/umt/EgovEmplyrDelete.do'/>";
	    document.emplyrManageVO.submit();
	}
}
function fnPasswordMove(){
	document.emplyrManageVO.action = "<c:url value='/uss/umt/EgovEmplyrPasswordUpdtView.do'/>";
    document.emplyrManageVO.submit();
}
...
<body>
<!-- content start -->
<form:form modelAttribute="emplyrManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovEmplyrSelectUpdt.do" name="emplyrManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;"> 
<div class="wTableFrm">
