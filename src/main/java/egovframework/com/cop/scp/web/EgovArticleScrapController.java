 ...
 *   2024.02.22  이백행          보안약점 조치: 부적절한 예외 처리 (광범위한 예외객체 선언)
 *
 *      </pre>
 */
...
public class EgovArticleScrapController {
	...
	public String insertArticleScrap(@ModelAttribute("searchVO") ScrapVO scrapVO, @ModelAttribute("scrap") Scrap scrap,
			BindingResult bindingResult, ModelMap model) throws FdlException {
	...
	public String updateArticleScrapView(@ModelAttribute("searchVO") ScrapVO scrapVO,
			@ModelAttribute("scrap") Scrap scrap, ModelMap model) {
...
//    public String selectScrapMainList(@ModelAttribute("searchVO") ScrapVO scrapVO, ModelMap model)  {
//	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
//
