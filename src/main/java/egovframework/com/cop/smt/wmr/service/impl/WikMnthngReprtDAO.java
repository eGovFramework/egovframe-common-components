...
public class WikMnthngReprtDAO extends EgovComAbstractDAO {
     ...
     * @param reportrVO
     */
    public Integer selectReportrListCnt(ReportrVO reportrVO) {
        return selectOne("WikMnthngReprtDAO.selectReportrListCnt", reportrVO);
    }
    ...
    public String selectWrterClsfNm(String wrterId) {
        return selectOne("WikMnthngReprtDAO.selectWrterClsfNm", wrterId);
    }
     ...
     */
    public int updateWikMnthngReprt(WikMnthngReprt wikMnthngReprt) {
        //날짜관련
        ...
        return update("WikMnthngReprtDAO.updateWikMnthngReprt", wikMnthngReprt);
    }
     ...
     * @param wikMnthngReprt
     */
    public int insertWikMnthngReprt(WikMnthngReprt wikMnthngReprt) {
        //날짜관련
        //KISA 보안약점 조치 (2018-10-29, 윤창원)
        wikMnthngReprt.setReprtDe(EgovStringUtil.isNullToString(wikMnthngReprt.getReprtDe()).replaceAll("-", ""));
        wikMnthngReprt.setReprtBgnDe(EgovStringUtil.isNullToString(wikMnthngReprt.getReprtBgnDe()).replaceAll("-", ""));
        ...
        return insert("WikMnthngReprtDAO.insertWikMnthngReprt", wikMnthngReprt);
    }
     ...
     * @param wikMnthngReprt
     */
    public int deleteWikMnthngReprt(WikMnthngReprt wikMnthngReprt) {
        return delete("WikMnthngReprtDAO.deleteWikMnthngReprt", wikMnthngReprt);
    }
     ...
     * @param wikMnthngReprt
     */
    public int confirmWikMnthngReprt(WikMnthngReprt wikMnthngReprt) {
        return update("WikMnthngReprtDAO.confirmWikMnthngReprt", wikMnthngReprt);
    }
     ...
     * @param wikMnthngReprtVO
     */
    public Integer selectWikMnthngReprtListCnt(WikMnthngReprtVO wikMnthngReprtVO) {
        //날짜관련
        //KISA 보안약점 조치 (2018-10-29, 윤창원)
        ...
        return selectOne("WikMnthngReprtDAO.selectWikMnthngReprtListCnt", wikMnthngReprtVO);
    }
