...
public class EgovLeaderSchdulController {
	...
	public String selectLeaderSchdulMonthList(@ModelAttribute("searchVO") LeaderSchdulVO leaderSchdulVO, ModelMap model)
		...
		// String(leaderSchdulVO.getSearchKeywordEx().getBytes("8859_1"), "UTF-8"));
		// }
		model.addAttribute("searchKeyword",
				leaderSchdulVO.getSearchKeyword() == null ? "" : (String) leaderSchdulVO.getSearchKeyword());
		model.addAttribute("searchKeywordEx",
				leaderSchdulVO.getSearchKeywordEx() == null ? "" : (String) leaderSchdulVO.getSearchKeywordEx());
		model.addAttribute("searchCondition",
				leaderSchdulVO.getSearchCondition() == null ? "" : (String) leaderSchdulVO.getSearchCondition());
		...
		if (sYear == null || sMonth == null || sYear.equals("") || sMonth.equals("")) {
			...
			sSearchMonth += Integer.toString(iMonth + 1).length() == 1 ? "0" + Integer.toString(iMonth + 1)
	...
	public String modifyLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO, ModelMap model)
		...
		resultVO.setSchdulBgndeYYYMMDD(
		...
		resultVO.setSchdulEnddeYYYMMDD(
	...
	public String addLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO,
		...
		model.addAttribute("schdulChargerId",
				loginVO == null ? "" : EgovStringUtil.isNullToString(loginVO.getUniqId()));
		model.addAttribute("schdulChargerName",
				loginVO == null ? "" : EgovStringUtil.isNullToString(loginVO.getName()));
