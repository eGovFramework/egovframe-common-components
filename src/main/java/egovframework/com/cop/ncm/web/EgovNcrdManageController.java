...
public class EgovNcrdManageController {
	...
	public String deleteNcrdItem(@ModelAttribute("searchVO") NameCardVO ncrdVO, SessionStatus status, ModelMap model) {
	...
	public String insertNcrdItem(@ModelAttribute("searchVO") NameCardVO ncrdVO,
			@ModelAttribute("nameCard") NameCard nameCard, BindingResult bindingResult, SessionStatus status,
	...
	public String selectNcrdItem(@ModelAttribute("searchVO") NameCardVO ncrdVO, SessionStatus status, ModelMap model) {
	...
	public String insertNcrdUseInf(@ModelAttribute("ncrdUser") NameCardUser ncrdUser,
			@ModelAttribute("ncrdVO") NameCardVO ncrdVO, SessionStatus status, ModelMap model) {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		// KISA 보안취약점 조치 (2018-12-10, 신용호)
		if (!isAuthenticated) {
	...
	public String selectNcrdUseInf(@ModelAttribute("searchVO") NameCardUser ncrdUser, SessionStatus status,
			ModelMap model) {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		// KISA 보안취약점 조치 (2018-12-10, 신용호)
	...
	public String updateNcrdUseInf(@ModelAttribute("ncrdUser") NameCardUser ncrdUser,
			@ModelAttribute("ncrdVO") NameCardVO ncrdVO, SessionStatus status, ModelMap model) {
