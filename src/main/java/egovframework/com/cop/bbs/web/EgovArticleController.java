...
public class EgovArticleController {
  ...
  public String selectArticleDetail(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model)
    ...
    if (!EgovStringUtil.isEmpty(vo.getSecretAt()) && vo.getSecretAt().equals("Y") && !(
        (user == null || user.getUniqId() == null) ? "" : user.getUniqId()).equals(
  ...
  public String insertArticle(final MultipartHttpServletRequest multiRequest,
      ...
      @ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") BoardVO board,
    ...
    if (board.getAnonymousAt() != null && board.getAnonymousAt().equals("Y")) {
      ...
      board.setNtcrId((user == null || user.getUniqId() == null) ? ""
          : user.getUniqId()); //게시물 통계 집계를 위해 등록자 ID 저장
  ...
  public String replyBoardArticle(final MultipartHttpServletRequest multiRequest,
    ...
    if (board.getAnonymousAt() != null && board.getAnonymousAt().equals("Y")) {
      ...
      board.setNtcrId(
          (user == null || user.getId() == null) ? "" : user.getId()); //게시물 통계 집계를 위해 등록자 ID 저장
      board.setNtcrNm((user == null || user.getName() == null) ? ""
          : user.getName()); //게시물 통계 집계를 위해 등록자 Name 저장
  ...
  public String updateArticleView(@ModelAttribute("searchVO") BoardVO boardVO,
  ...
  public String deleteGuestList(@ModelAttribute("searchVO") BoardVO boardVO,
      @ModelAttribute("articleVO") Board board, ModelMap model) throws Exception {
  ...
  public String updateGuestArticleView(@ModelAttribute("searchVO") BoardVO boardVO,
      @ModelAttribute("boardMasterVO") BoardMasterVO brdMstrVO,
      ModelMap model) throws Exception {
  ...
  public String updateGuestArticle(@ModelAttribute("searchVO") BoardVO boardVO,
      @ModelAttribute Board board, BindingResult bindingResult,
      ModelMap model) throws Exception {
  ...
  public ModelAndView selectArticleBlogDetail(@ModelAttribute("searchVO") BoardVO boardVO,
      ModelMap model) throws Exception {
    LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
