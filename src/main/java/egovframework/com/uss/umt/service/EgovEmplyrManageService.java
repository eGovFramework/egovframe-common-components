 ...
 * </pre>
 */
public interface EgovEmplyrManageService  {
	 ...
	 * @throws Exception
	 */
	public void deleteEmplyr(String checkedIdForDel) throws Exception;
	 ...
	 * @throws Exception
	 */
	public EmplyrManageVO selectEmplyr(String emplyrId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<EgovMap> selectEmplyrList(UserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int selectEmplyrListTotCnt(UserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String insertEmplyrHistory(EmplyrManageVO emplyrManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public EmplyrPasswordManageVO selectPassword(EmplyrPasswordManageVO emplyrPasswordManageVO) throws Exception;
