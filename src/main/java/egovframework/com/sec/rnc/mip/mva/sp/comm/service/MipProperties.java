...
public class MipProperties {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(MipProperties.class);
	...
	public static final String RELATIVE_PATH_PREFIX = MipProperties.class.getResource("") == null ? ""
		: MipProperties.class.getResource("").getPath().substring(0,
			MipProperties.class.getResource("").getPath().lastIndexOf("com/"));
	...
	public static final String MIP_PROPERTIES_FILE = RELATIVE_PATH_PREFIX + "mip"
				+ FILE_SEPARATOR + "mip.properties";
	...
	public static String getProperty(String keyName) {
		...
		LOGGER.debug("===>>> getProperty" + EgovStringUtil.isNullToString(MipProperties.class.getProtectionDomain().getCodeSource().getLocation().getPath()));
		LOGGER.debug("getProperty : {} = {}", MIP_PROPERTIES_FILE, keyName);
	...
	public static String getPropertyValueByKey(String keyName) {
		return getPropertyValueByKey(MIP_PROPERTIES_FILE, keyName);
	}
