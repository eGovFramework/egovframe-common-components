...
public class EgovRoleManageController {
	...
	public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
			@ModelAttribute("roleManage") RoleManage roleManage, ModelMap model) {
	...
	public String insertRole(@ModelAttribute("roleManage") RoleManage roleManage,
		...
		if (bindingResult.hasErrors()) {
			...
			try {
				...
				throw new BaseRuntimeException("FdlException egovRoleIdGnrService", e);
			}
	...
	public String deleteRole(@ModelAttribute("roleManage") RoleManage roleManage, ModelMap model) {
	...
	public String deleteRoleList(@RequestParam("roleCodes") String roleCodes,
			@ModelAttribute("roleManage") RoleManage roleManage, Model model) {
