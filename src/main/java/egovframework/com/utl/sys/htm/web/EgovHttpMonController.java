...
public class EgovHttpMonController {
	...
	public String insertHttpMon(@ModelAttribute("httpMon") HttpMon httpMon, BindingResult bindingResult, ModelMap model)
			throws Exception {
	...
	public String updateHttpMon(@ModelAttribute("loginVO") LoginVO loginVO, @ModelAttribute("httpMon") HttpMon httpMon,
