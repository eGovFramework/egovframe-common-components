 ...
 *   2024.08.14  이백행          시큐어코딩 일련번호 PK 파라미터 암복호화
 *          </pre>
 */
@Controller
public class EgovLoginPolicyController {
	...
	public String selectLoginPolicy(@RequestParam("emplyrId") String emplyrId,
		...
		loginPolicyVO.setEmplyrId(EgovFileMngController.decrypt(loginPolicyVO.getEmplyrIdEncrypt()));
	...
	public String insertLoginPolicy(@ModelAttribute("loginPolicy") LoginPolicy loginPolicy, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			...
			loginPolicy.setEmplyrId(EgovFileMngController.decrypt(loginPolicy.getEmplyrIdEncrypt()));
