...
/**
 * 개요 - 보고서통계에 대한 controller 클래스를 정의한다.
 * 
 * 상세내용 - 보고서통계에 대한 등록, 조회 기능을 제공한다. - 보고서통계의 조회기능은 목록조회, 상세조회로 구분된다.
 * 
 * @author lee.m.j
 * @version 1.0
...
public class EgovReprtStatsController {
	...
	public String selectReprtStatsListView(@ModelAttribute("comDefaultCodeVO") ComDefaultCodeVO comDefaultCodeVO,
			@ModelAttribute("pmReprtStats") ReprtStatsVO reprtStatsVO, ModelMap model) {
	...
	public String selectReprtStatsList(@RequestParam("pmReprtTy") String pmReprtTy,
			@RequestParam("pmDateTy") String pmDateTy, @RequestParam("pmFromDate") String pmFromDate,
			@RequestParam("pmToDate") String pmToDate,
			@ModelAttribute("comDefaultCodeVO") ComDefaultCodeVO comDefaultCodeVO,
			@ModelAttribute("reprtStatsVO") ReprtStatsVO reprtStatsVO, ModelMap model) {
		...
		reprtStatsVO
				.setReprtStatsByReprtSttusList(egovReprtStatsService.selectReprtStatsByReprtSttusList(reprtStatsVO));
	...
	public String selectReprtStats(@ModelAttribute("reprtStatsVO") ReprtStatsVO reprtStatsVO,
			@RequestParam("reprtTy") String reprtTy, @RequestParam("reprtSttus") String reprtSttus, ModelMap model) {
	...
	public String insertViewReprtStats(@ModelAttribute("reprtStatsVO") ReprtStatsVO reprtStatsVO,
			@ModelAttribute("comDefaultCodeVO") ComDefaultCodeVO comDefaultCodeVO, ModelMap model) {
	...
	public String insertReprtStats(@ModelAttribute("reprtStats") ReprtStats reprtStats,
			@ModelAttribute("reprtStatsVO") ReprtStatsVO reprtStatsVO, BindingResult bindingResult, ModelMap model) {
