...
public class EgovUserInfManageDAOTest extends EgovTestAbstractDAO {
	...
	void testData() {
		 ...
		 */
		/*
		 * try { testCommunity.setCmmntyId(egovCmmntyIdGnrService.getNextStringId()); }
	...
	public void testSelectUserList() {
		// given
		/*
		 * 기본 사용자 목록 ESNTL_ID USER_ID USER_NM USRCNFRM_00000000000 TEST1 테스트1
		 * USRCNFRM_00000000001 USER 일반회원 USRCNFRM_00000000002 ENTERPRISE NIA
