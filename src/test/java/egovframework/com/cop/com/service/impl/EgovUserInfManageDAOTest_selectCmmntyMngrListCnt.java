...
public class EgovUserInfManageDAOTest_selectCmmntyMngrListCnt extends EgovTestV1 {
...
//		P	회원 가입 승인 상태
	...
	void when() {
		try {
			cmmntyMngrsCnt = egovUserInfManageDAO.selectCmmntyMngrListCnt(userVO);
		} catch (Exception e) {
			log.error("Exception");
		}
	}
	...
	void then() {
		log.debug("cmmntyMngrsCnt={}, {}", cmmntyMngrsCnt, 1);

		assertEquals(cmmntyMngrsCnt, 1);
	}
