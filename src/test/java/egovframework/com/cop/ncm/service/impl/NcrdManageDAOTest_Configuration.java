...
@ComponentScan(useDefaultFilters = false, basePackages = {
		"egovframework.com.cop.ncm.service.impl" }, includeFilters = {
				@Filter(type = FilterType.ASSIGNABLE_TYPE, classes = { NcrdManageDAO.class }) })

public class NcrdManageDAOTest_Configuration {
