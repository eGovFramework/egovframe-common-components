...
@ContextConfiguration(classes = { EgovFileMngServiceImplTest_updateFileInfs.class })
...
public class EgovFileMngServiceImplTest_updateFileInfs {
	...
	public void test() throws Exception {
		...
		try {
			service.updateFileInfs(fileList);
			result = true;
		} catch (Exception e) {
