...
public class TestClassPath {
	...
	public static void main(String[] args) {
		...
		// 개선된 방법
		log.debug(">>> TEST CLASS PATH7 = {}{}", EgovProperties.class.getProtectionDomain().getCodeSource().getLocation().getPath(), EgovProperties.class.getResource("").getPath().substring(0, EgovProperties.class.getResource("").getPath().lastIndexOf("com"))
